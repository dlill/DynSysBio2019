...
* Implement the newton method <img src="/Exercises/tex/a66c3ed9cfd3a3dbb6c3594ee19f5c3b.svg?invert_in_darkmode&sanitize=true" align=middle width=135.24718514999998pt height=33.20539859999999pt/> in a function `newton_solve(x0, p; prec = 1e-8)` with initial value `x0`, parameter vector `p` and precision `prec`. Stop the iterations when |xn+1−xn|< prec is reached.
