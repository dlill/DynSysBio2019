...
find the points <img src="/Exercises/tex/33717a96ef162d4ca3780ca7d161f7ad.svg?invert_in_darkmode&sanitize=true" align=middle width=9.39498779999999pt height=18.666631500000015pt/> where <img src="/Exercises/tex/6c47ef861cd2f6846c995db25bd78ec2.svg?invert_in_darkmode&sanitize=true" align=middle width=578.8071069pt height=48.85840410000001pt/>\f(x,\vec{p})<img src="/Exercises/tex/fd92a53167b3c6ae9574071613d555dc.svg?invert_in_darkmode&sanitize=true" align=middle width=27.11199479999999pt height=22.831056599999986pt/>f'(x,\vec{p})<img src="/Exercises/tex/61f01ed781a2a902e1da1af5a5cc6b06.svg?invert_in_darkmode&sanitize=true" align=middle width=327.93203685pt height=22.831056599999986pt/>x_{n+1} = x_n - \frac{f(x_n)}{f'(x_n)}$ in a function `newton_solve(x0, p; prec = 1e-8)` with initial value `x0`, parameter vector `p` and precision `prec`. Stop the iterations when |xn+1−xn|< prec is reached.
